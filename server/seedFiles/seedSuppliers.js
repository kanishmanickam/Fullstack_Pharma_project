...
const suppliers = [
  ...
  },
  {
    ...
    medicine_categories: ["Cough Suppressant", "Antihistamine", "Analgesic"],
    is_active: true,
  ...
  },
  {
    ...
    medicine_categories: ["Topical", "Antibiotic", "Antihistamine"],
    is_active: true,
...
const seedSuppliers = async () => {
  try {
    ...
    created.forEach((sup) =>
      console.log(`  - ${sup.supplier_name} (${sup._id})`),
    );
